...
import { Bot, Paperclip, Send, User, X } from "lucide-react";
...
// Panel chat AI Assistant bersama — dipakai baik oleh halaman AI Assistant (/financial)
// maupun bubble mengambang, keduanya lewat endpoint universal /api/assistant/financial-chat
// sehingga kemampuannya (tools + lampiran file) selalu identik di kedua tempat.
export function AssistantChatPanel({
  ...
  return (
    <div className={cn("flex flex-col", variant === "bubble" ? "h-full" : "")}>
      <div className="flex items-center justify-between gap-2.5 border-b border-slate-100 dark:border-slate-700 px-5 py-4">
      ...
      <div className={cn("space-y-3 overflow-y-auto p-5", variant === "bubble" ? "flex-1 min-h-0" : "max-h-[60vh] min-h-[20rem]")}>
        {messages.length === 0 && (
